  ...
  useEffect(() => {
    const fetchDocuments = async () => {
      ...
      try {
        ...
        const userDocsResponse = await axios.get(`${import.meta.env.BACKEND_URL}/api/documents`, {
          headers: {
        ...
        // Fetch all documents
        const allDocsResponse = await axios.get(`${import.meta.env.BACKEND_URL}/api/documents/all`, {
          headers: {
            Authorization: `Bearer ${token}`,
          },
        });
